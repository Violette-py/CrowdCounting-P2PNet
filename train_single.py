...
def get_args_parser():
    ...
    parser.add_argument('--train_img_dir', default='D:/Desktop/AIA/DroneRGBT/Train/RGB',  
                        help='path where the train image in')
    parser.add_argument('--train_gt_dir', default='D:/Desktop/AIA/DroneRGBT/Train/GT_Point',  
                        help='path where the train ground truth in')
    parser.add_argument('--test_img_dir', default='D:/Desktop/AIA/DroneRGBT/Val_select/RGB',  
                        help='path where the test image in')
    parser.add_argument('--test_gt_dir', default='D:/Desktop/AIA/DroneRGBT/Val_select/GT_Point',  
                        help='path where the test ground truth in')  
